        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-start py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z-1">
            ...
            <div data-aos="flip-right" class="space-y-8">
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-8">
                        <div v-for="element in workExperience" :key="element.id" class="flex items-center rounded-xl shadow-lg border border-[#1f1641] py-3 bg-gradient-to-r from-[#111a3e] to-[#111a3e]">
                            <div class="w-full pl-4">
                                <h3 class="text-cyan-300 text-left text-2xl">
                                    {{ element.Company }}
                                </h3>
