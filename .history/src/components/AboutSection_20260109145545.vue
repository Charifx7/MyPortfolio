<template>
    <section class="text-white mt-18 w-full" id="about">
        <div class="absolute z-0 top-[93rem] inset-x-0 h-64 flex items-start">
            <div class="h-24 w-64 bg-gradient-to-br opacity-20"></div>
        </div>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-start py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z-1">
            <!-- Education Section -->
            <div data-aos="flip-right" class="space-y-8">
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-8">
                        <div v-for="element in workExperience" :key="element.id" class="flex items-center rounded-xl shadow-lg border border-[#1f1641] py-3 bg-gradient-to-r from-[#111a3e] to-[#111a3e]"></div>
                    </div>
                </div>
            </div>
...
const workExperience = ref([
    {
        id: 1,
        Company: 'Internship at ABC Company',
